        ...
        <el-form label-width="100px" :inline="false" size="normal">
            ...
            <el-form-item label="平台属性">
                <div v-for="(attr, index) in platformAttrs" :key="attr.id"
                    ...
                    <el-select placeholder="请选择" style="width: 240px" v-model="selectedPlatformAttrs[index].valueId">
...
import type { platformValue, saleValue, imagesValue, SkuData, responseData } from '@/api/product/sku/type';
