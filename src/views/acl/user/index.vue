<template>
    <div class="user-container">
            ...
            <div class="form-row">
                ...
                <div class="button-group">
                    <el-button type="primary" size="default" @click="handleSearch"
                        style="width: 50px;height: 25px;">搜索</el-button>
                    <el-button type="default" size="default" @click="handleReset"
                        style="width: 50px;height: 25px;">重置</el-button>
                </div>
            </div>
        </el-card>
        <el-card shadow="always" :body-style="{ padding: '20px' }" style="margin-bottom: 10px;">
            <el-button type="primary" size="large" @click="handleAdd"
                style="margin-right: 5px;padding: 5px 10px;">添加</el-button>
            <el-button type="danger" size="large" @click="handleDelete" style="padding: 5px 5px;">批量删除</el-button>
            <el-table :data="userList" border stripe style="margin-top: 10px;" @selection-change="selectChange">
                ...
                <el-table-column label="id" width="60px" prop="userId">
                </el-table-column>
                <el-table-column label="账户" width="100px" prop="userNumber">
                </el-table-column>
                <el-table-column label="昵称" width="100px" prop="userName" show-overflow-tooltip>
                </el-table-column>
                <el-table-column label="用户角色" width="100px" prop="roles" show-overflow-tooltip>
                </el-table-column>
                <el-table-column label="创建时间" width="100px" prop="createTime" show-overflow-tooltip>
                </el-table-column>
                <el-table-column label="更新时间" width="100px" prop="updateTime" show-overflow-tooltip>
                </el-table-column>
                <el-table-column label="操作">
                    <template #="{ row, $index }">
                        <el-button type="primary" size="default" @click="handleRoles(row)" icon="User">分配角色</el-button>
                        <el-button type="primary" size="default" @click="handleUpdate(row)" icon="Edit">编辑</el-button>
                        <el-popconfirm :title="`确认删除${row.userName}吗？`" width="200px"
        ...
        <el-dialog :title="title" v-model="isDialog" width="50%">
            <el-form :model="form" :rules="rules" ref="formRef" label-width="80px" :inline="false" size="normal"
                status-icon>
        ...
        <!-- 分配角色抽屉 -->
        <el-drawer title="给用户分配角色" v-model="isDrawer" direction="rtl" size="30%" :destroy-on-close="true"
...
import { reqUserInfo, reqAddorUpdateUser, reqDeleteUser, reqGetRoleList, reqAssignRoles } from '@/api/acl/userManage'
import type { userResponseData, userList, AddUserData, responseData, deleteUser, roleLists } from '@/api/acl/userManage/type'
...
const rules = {
    userNumber: [{ required: true, trigger: 'change', validator: validateUserNumber }],
