...
// 更新或者修改权限
export const reqAddOrUpdatePermission = (form: UpdateOrAddMenuData) =>
  request.post<UpdateOrAddMenuData, ResponseData>(
    API.ADDorUPDATEPERMISSION_URL,
    form,
  )
// 删除菜单
export const reqDeletePermission = (id: number) =>
  request.delete<any, ResponseData>(`${API.DELETEPERMISSION_URL}/${id}`)
